...
自 2026 年 4 月 16 日起，本人启用  GitHub 提交签名机制，用于标识提交的来源与完整性（[Learn about vigilant mode](https://docs.github.com/en/authentication/managing-commit-signature-verification/displaying-verification-statuses-for-all-of-your-commits)）。
...
- 通过 GitHub 网页（github.com）创建的提交由 GitHub 官方密钥签名，不使用上述 SSH Key。
